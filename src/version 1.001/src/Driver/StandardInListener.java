...
public class StandardInListener extends Thread implements Runnable
{
	...
	public boolean display_status()
	{
		try
		{
			...
			if(driver.fle_path_app_data_chrome_cookies != null && driver.fle_path_app_data_chrome_cookies.isFile())
				driver.directive("Path to Chrome Cookie sqlite3 database: " + driver.fle_path_app_data_chrome_cookies.getCanonicalPath());
			
			
			if(driver.fle_path_app_data_microsoft_cookies != null && driver.fle_path_app_data_microsoft_cookies.isDirectory())
				driver.directive("Path to Internet Explorer Cookie cache: " + driver.fle_path_app_data_microsoft_cookies.getCanonicalPath());
	...
	public static boolean export()
	{
		try
		{
			driver.directive("Exporting cookie information. Please stand by...");
			String path = Cookie_Container_Host_System.export_cookies(true, "\t");
			
			if(path != null && !path.trim().equals(""))
				driver.directive("Complete. If successful, cookie data has been exported to path --> " + path);
			else
				driver.directive("Hmm... I'm not sure I was able to process cookie export properly...");
